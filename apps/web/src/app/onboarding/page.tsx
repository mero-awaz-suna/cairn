...
export default function OnboardingPage() {
  ...
  async function handleComplete() {
    ...
    // Call backend to create persona with demographics
    try {
      ...
      // Non-blocking — persona will be created on first journal entry if this fails
  ...
  function OptionButton({ selected, onClick, icon, label, bold, delay }: {
